...
export const shelfSystemReducer = createReducer(
    ...
    on(ShelfSystemActions.loadShelfSystemSuccess, (state, { system }) => ({ ...initialState, systemId: system.systemid, systemName: system.systemname, system: system.system, shelves: system.shelves })),
